...
# f = open('C:/sorce/iot-python-2025/day03/test2.txt', mode='w', encoding='utf-8')
# f = open('../test.txt', mode='w', encoding='utf-8')
# \를 문자열에 표현하고 싶으면
# f = open('C:\\sorce\\iot-python-2025\\day03\\test4.txt', mode='w', encoding='utf-8')
