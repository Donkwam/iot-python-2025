...
pygame.display.set_caption('Pygame Gtaphic')
...
def main():
    ...
    while True:
        ...
        line(Surface, (0,255,0), (30,60), (150, 60), 5) # 위에 (from pygame.draw import *)를 사용하면 앞에 pygame.draw 사용없이 사용가능
        line(Surface, (0,0,255), (30, 90), (150, 150), 7)

        # 사각형
        pygame.draw.rect(Surface, color='white', rect=(200, 30, 50, 50))    # 정사각형 (x, y, x축 길이, y축 길이)
        rect(Surface, (255,0,0), (260, 30, 100, 50), 3)    # 직사각형

        # 원(중심을 시작점으로)
        pygame.draw.circle(Surface, (255, 255, 0), (40, 180), 10)   # 색깔 위치 크기
