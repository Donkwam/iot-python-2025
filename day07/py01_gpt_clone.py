...
# 8. 입력창에서 엔터를 치면 keypress이벤트 발생
textMessage.bind('<Key>', keypress)
textMessage.pack(side=LEFT, padx=15)

buttonSend = Button(inputFrame, text='전송', bg='green', fg='white', font=myFont, command=responsMessage)
...
textResult.tag_configure('ai', font=myFont, foreground='limegreen') # 'limegreen' -> #89F336
